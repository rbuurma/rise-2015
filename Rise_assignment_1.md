...
3. This will open the NER program in two windows: in your Terminal and in a Java [word?]. In the second window, erase the pre-loaded text and use the Open File command to open the clean Project Gutenberg version of *Crusoe* you will find in both the assignment folder and the repository. (We will talk more about how we create and find usable machine-readable text files of our novels in future assignments, and you will learn to create them yourself.)
...
8. Repeat for the six other types of extracted entities.
...
How does the Stanford NER work?

Underwood's Mapping Genre + the Robinsonade (and reprints, revisions of RC)
Find that book on reprints of RC
